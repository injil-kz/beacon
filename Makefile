publish:
	...
	cd packages/beacon_graphql_adapter && dart pub publish
	cd packages/beacon_supabase_adapter && dart pub publish
...
version:
	...
	cd packages/beacon_graphql_adapter && cider bump patch
	cd packages/beacon_supabase_adapter && cider bump patch
...
pub_analyze:
	...
	cd packages/beacon_graphql_adapter && flutter pub publish --dry-run
	cd packages/beacon_supabase_adapter && flutter pub publish --dry-run
